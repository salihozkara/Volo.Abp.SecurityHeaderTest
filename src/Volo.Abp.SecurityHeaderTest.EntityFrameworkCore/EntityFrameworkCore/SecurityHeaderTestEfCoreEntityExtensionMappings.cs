...
public static class SecurityHeaderTestEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SecurityHeaderTestModuleExtensionConfigurator CLASS (in the Domain.Shared project)
